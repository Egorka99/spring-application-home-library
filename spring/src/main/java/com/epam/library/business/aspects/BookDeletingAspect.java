...
public class BookDeletingAspect {
    ...
    @AfterReturning("execution (* com.epam.library.business.impl.BookService.deleteBook(..))")
    ...
    @AfterThrowing(
            pointcut = "execution (* com.epam.library.business.impl.BookService.deleteBook(..))",
            throwing = "ex")
