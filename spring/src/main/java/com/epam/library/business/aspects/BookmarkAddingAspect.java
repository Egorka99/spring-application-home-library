...
public class BookmarkAddingAspect {
    ...
    @AfterReturning("execution (* com.epam.library.business.impl.BookmarkService.addNewBookmark(..))")
    ...
    @AfterThrowing(
            pointcut = "execution (* com.epam.library.business.impl.BookmarkService.addNewBookmark(..))",
            throwing = "ex")
